...
import { MultipleChoiceComponent } from './components/splash/interaction/multipleChoice.component'
...
@NgModule({
  ...
  declarations: [ AppComponent, UserComponent, AboutComponent, SplashComponent, InteractionComponent, FreeTypeComponent, YesNoComponent, MultipleChoiceComponent, FakeTypeComponent, FocusDirective, Autosize, VideoComponent ],
